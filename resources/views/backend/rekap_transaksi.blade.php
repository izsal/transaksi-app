                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between my-3">
                        ...
                        <div class="d-flex align-items-center">
                            <input type="text" class="form-control datepicker" placeholder="Start" id="tglStart"
                                name="tgl-start">
                            <span class="mx-2">to</span>
                            <input type="text" class="form-control datepicker" placeholder="End" id="tglEnd"
                                name="tgl-end">
...
@push('after-scripts')
    ...
    <script type="text/javascript">
        ...
        let table = $('#datatable').DataTable({
            ...
            ajax: {
                url: '{{ route('backend.rekap_list_transaksi') }}',
                data: function(d) {
